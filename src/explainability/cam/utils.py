...
def save_cams(model_name="TransformerConv3DV2", cam_method="gradcam++", num_workers=20, cuda_idx=[0], num_slices=100,
              random_seed=42):
    """
    ...
    for i, (train_val_subj_index, test_subj_index) in enumerate(kf.split(subjects)):
        ...
        coronal_plane_model = os.path.join(experiments_path,

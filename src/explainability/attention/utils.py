...
def inference(model_name="Axial3DVGG16", random_seed=42, num_workers=10, cuda_idx=[0], num_slices=100):
    ...
    task = ['CN', 'AD']
    dataset = "/home/diaoyueqin/AXIAL-main/data/ADNI_BIDS/dataset_new2.csv"
    ...
    for i, (train_val_subj_index, test_subj_index) in enumerate(kf.split(subjects)):
        ...
        axial_plane_model = os.path.join(experiments_path, f"/home/diaoyueqin/AXIAL-main/runs/ADNI1Complete1Yr1.5T/AD vs CN/3D/axial/Axial3D/VGG16/ImageNet/rand_seed_42_val_split_0.2_epochs_100_lr_0.0001_batch_size_4_dropout_0.3_wd_0.0001_freeze_0.4_slices_80_optim_adamw_scheduler_none_pretrained_false/2025-01-15-10-32/fold_{fold_num}/torch_model/best_model.pth")
        sagittal_plane_model = os.path.join(experiments_path, f"/home/diaoyueqin/AXIAL-main/runs/ADNI1Complete1Yr1.5T/AD vs CN/3D/sagittal/Axial3D/VGG16/ImageNet/rand_seed_42_val_split_0.2_epochs_100_lr_1e-05_batch_size_4_dropout_0.3_wd_0.0001_freeze_0.4_slices_80_optim_adamw_scheduler_none_pretrained_false/2025-02-08-23-19/fold_{fold_num}/torch_model/best_model.pth")
        coronal_plane_model = os.path.join(experiments_path, f"/home/diaoyueqin/AXIAL-main/runs/ADNI1Complete1Yr1.5T/AD vs CN/3D/coronal/Axial3D/VGG16/ImageNet/rand_seed_42_val_split_0.2_epochs_100_lr_1e-05_batch_size_4_dropout_0.3_wd_0.0001_freeze_0.4_slices_80_optim_adamw_scheduler_none_pretrained_false/2025-02-08-11-13/fold_{fold_num}/torch_model/best_model.pth")

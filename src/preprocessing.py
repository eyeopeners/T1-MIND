...
def preproc_pipeline(in_file, out_dir, n_proc=None):
    ...
    # # if os.path.isfile(n4_corrected_path):
    # #     os.remove(n4_corrected_path)
    #
    ...
    # n4.run()
    # # Set up AntsRegistrationQuick interfacedf -h
    # for filename in os.listdir(out_dir):
    #     file_path = os.path.join(out_dir, filename)
    #     if os.path.isfile(
    #             file_path) and file_path != in_file and file_path != n4_corrected_path :
    #         os.remove(file_path)
    ...
    #     file_path = os.path.join(out_dir, filename)
    #     if os.path.isfile(
    #             file_path) and file_path != in_file and file_path != registered_image_path and file_path != n4_corrected_path:
    #         os.remove(file_path)
    registered_image_path = os.path.join(out_dir, os.path.splitext(os.path.splitext(os.path.basename(in_file))[0])[
        0]) + '_space-MNI152_desc-preproc-N4.nii.gz'
